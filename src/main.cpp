...
int main(int, char**)
{
    ...
    GLFWwindow* window = glfwCreateWindow(1280, 720, "DirViewer PoC", NULL, NULL);
    if (window == NULL)
        return 1;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Design small logic function, with static members in main function
        // in game loop only rendering and event responses
        //  maybe refactor it into application class?
        //  The tree does not need to be redrawn each frame, only when there is some change triggered
        application.Update();
